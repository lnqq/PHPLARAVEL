                                ...
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                            ...
                                            <ul style="list-style: none;"> 
                                                    ...
                                                    <li>
                                                        <input type="radio" class="rdoAddress" name="rdoaddress" value="" style="float: left;">
                ...
                <div class="modal-body">
                    <form method="post" action="">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control phone" placeholder="Nhập Tên" name="phone" required="">
                            <label class="col-form-label errorPhone" style="color: red;"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Họ: </label>
                            <input type="text" class="form-control phone" placeholder="Nhập Họ" name="phone" required="">
                            <label class="col-form-label errorPhone" style="color: red;"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Địa Chỉ Email:</label>
                            <input type="text" class="form-control email" value="" placeholder="Nhập địa chỉ email" name="email" required="">
                            <label class="col-form-label errorEmail" style="color: red;"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">postal_address: </label>
                            <input type="text" class="form-control phone" placeholder="Nhập postal_address" name="phone" required="">
                            <label class="col-form-label errorPhone" style="color: red;"></label>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">physical_address:</label>
